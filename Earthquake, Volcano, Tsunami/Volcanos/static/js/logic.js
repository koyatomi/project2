...
function createFeatures(volcanoData) {
  ...
  // Giving each feature a popup describing the place and name of the volcanos
  function onEachFeature(feature, layer) {
    layer.bindPopup("<h3>" + feature.properties.Country +
      "</h3><hr><p>" + (feature.properties.V_Name) + ", Popl. Exposure Index: " + feature.properties.PEI + "</p>");
  }
  ...
  // Creating a GeoJSON layer containing the features array on the volcanoData object
...
function createMap(volcanos) {
  ...
  legend.onAdd = function (map) {
    ...
    div.innerHTML += "<h4 style='margin:4px'>Pop.Exp.Ind.</h4>"
